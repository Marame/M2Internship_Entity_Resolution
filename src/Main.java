...
public class Main {
    ...
    // versions of VSM
    String[] versions = {"VSM Binary","VSM with TF", "Improved VSM with IDF", "Solving problem Presidential vs About", "VSM with TFxIDF"};
    ...
    public void startTestingVSM() throws IOException {
     ...
     // for(String version :versions) {
          VSMTFxIDFVersion vsm = new VSMTFxIDFVersion("Solving problem Presidential vs About");
          HashMap<String, Float> scores = vsm.getRankingScores(query, docs);
          System.out.println("***********Results for" + "\t" + "VSM Binary" +"\t" + "version*********");
